 ...
 *
 * Ported verbatim from netlify/lib/password.js — only the module syntax changed
 * (CommonJS to ESM). The crypto logic is deliberately untouched: it is covered
 * by tests and it is the thing standing between the public internet and gated
 * client work.
 *
 ...
 */
export const verifyPassword = (candidate, stored) => {
