 ...
 *
 * Ported verbatim from netlify/lib/access-token.js — only the module syntax
 ...
 *
 * Requires CASE_STUDY_SECRET in the environment. If it is missing we fail
 * closed — no token can be issued and none can be verified.
 */
 ...
 */
export const verifyToken = (token, slug) => {
  const secret = getSecret()
